	...
	for(var i=0; i<makanan.length; i++){
		semua.push(
			<div style={{width:'20px', height:'50px'}}>
				<div className="card card-image" style={{backgroundImage: `url(${gambar[i]})`, height:'100%', width:'100%'}}>
					...
					<div>
						<h5 className="pink-text"><i class="fas fa-crown" /> {tanggal[i]}</h5>
        ...
        <div className='mb-5'>
			...
			<div className='subjudul'>
				<h3 className="card-title h3 my-4">Favorite Package of the Month</h3>
			...
			{/* Nanti angka 1 nya lempar dari props */}
			<Link to={'/ordercatering/'+parseInt(1)}> 
